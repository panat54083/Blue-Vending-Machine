...
export class Default1712589083668 implements MigrationInterface {
    name = 'Default1712589083668'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "coin_banknote" ("id" SERIAL NOT NULL, "denomination" integer NOT NULL, "stock" integer NOT NULL, CONSTRAINT "PK_c970c10ea243c2a40364230ebf8" PRIMARY KEY ("id"))`);
